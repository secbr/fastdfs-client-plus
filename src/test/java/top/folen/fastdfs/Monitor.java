...
public class Monitor {
	...
	protected static String getSyncedDelayString(StorageStatStruct[] storageStats,
                                                 StorageStatStruct currentStorageStat) {
		...
		int delaySeconds =
                (int) ((maxLastSourceUpdate - currentStorageStat.getLastSyncedTimestamp().getTime()) / 1000);
