      ...
      storageServer = tracker.getStoreStorage(trackerServer);
  		...
  		*/
			...
			if ((file_id = client.uploadFile1(local_filename, null, meta_list)) != null) {
				...
				prefix_name = "-part2";
				file_ext_name = null;
				slave_file_id = client.uploadFile1(master_file_id, prefix_name, local_filename, file_ext_name,
						meta_list);
				if (slave_file_id != null) {
					System.err.println("slave file_id: " + slave_file_id);
					System.err.println(client.getFileInfo1(slave_file_id));
			...
			file_id = client.uploadFile1(null, f.length(), new UploadLocalFileSender(local_filename), file_ext_name,
					meta_list);
			if (file_id != null) {
				...
				master_file_id = file_id;
				prefix_name = "-part3";
				slave_file_id = client.uploadFile1(master_file_id, prefix_name, f.length(),
